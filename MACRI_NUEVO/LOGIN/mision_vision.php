      ...
      <div class="col-md-6">
        <div class="card border-0">
          <div class="card-body">
            ...
            <p class="card-text">Proporcionar un espacio seguro y confidencial donde los individuos puedan explorar sus pensamientos, emociones y comportamientos. Tengo el compromiso de ofrecer terapia personalizada y basada en la evidencia, guiando al paciente hacia el autoconocimiento, el crecimiento 
                personal y la superación de los desafíos psicológicos que enfrentan en sus vidas.
            </p>
      ...
      <div class="col-md-6">
        <div class="card border-0">
          ...
          <h2 class="card-title">VISIÓN</h2>
            <p class="card-text">Ser líder en el campo de la salud mental, tener reconocimiento por excelencia en el cuidado psicológico y el compromiso con el bienestar integral del paciente. Todo el equipo de profesionales aspiramos a ser una fuente de inspiración y apoyo para aquellos que 
                buscan mejorar su salud mental y calidad de vida, contribuyendo así a comunidades más saludables y resilientes.
            </p>
          </div>
        </div>
      </div>
