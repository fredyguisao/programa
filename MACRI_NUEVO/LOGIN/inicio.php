          ...
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
              <h3 class="login-heading mb-4">Login de usuario</h3>
                 <h6>Por favor ingresa  con tu Usuario y contraseña. Si aún no tienes, te invito a registrarte. Ánimo, te espero.</h6>
              ...
              <form action="servidor/login/logear.php" method="post">
                ...
                <div class="d-grid">
                  ...
                  <div class="text-center">
                    <a class="small" href="index.php">REGRESAR AL INICIO</a>
                  </div>
                </div>
